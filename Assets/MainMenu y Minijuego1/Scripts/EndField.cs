...
public class EndField : MonoBehaviour, IDropHandler
{
    ...
    public void Update()
    {
        ...
        {
            string postURL = "https://192.xxxx:7149/Ranking/PostRanking";
            string puntosURL = "https://192.xxx:7149/Usuarios/UpdatePuntos";
            string expURL = "https://192.xxx:7149/Usuarios/UpdateExperiencia";
