...
public class FondoNivelUI : MonoBehaviour
{
    ...
    private string apiNivel = "https://10.22.168.234:7222/Niveles/GetNivelimg/";
    ...
    {
        string url = apiNivel.TrimEnd('/') + "/" + nivel;
    ...
    IEnumerator DescargarImagen(string url)
    {
        ...
        fondoSprite.transform.localScale = new Vector3(6f, 6f, 1f);
